...
# config_dict
model_weights_dir = '/projects/home/mmasood1/Model_weights/invitro/invitro_1million/MolBERT/Retrain_on_top_of_BERT/complete_1m_300k_ADME/BERT_pretraining_init_MolBERT_masking_head/'
...
config_dict['project_name'] = "BERT_pretraining_masking"
config_dict['model_name'] = "BERT_init_masking_head"
...
config_dict["device"] = torch.device("cuda:1")
...
config_dict["pretrained_crash_model"] = "/projects/home/mmasood1/Model_weights/invitro/invitro_1million/MolBERT/Retrain_on_top_of_BERT/complete_1m_300k_ADME/BERT_pretraining_init_MolBERT_masking_head/epoch=39-step=0.ckpt"
...
class MolbertModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        batch, valid = batch
        (corrupted_batch_inputs,_),  corrupted_batch_labels = batch
        Masked_token_pred = self.forward(corrupted_batch_inputs)
        masking_loss = self.MaskedLM_loss(corrupted_batch_labels, Masked_token_pred)
        return {"loss": masking_loss,
...
####################################################################################33
config_dict["metadata_dir"] = "/projects/home/mmasood1/trained_model_predictions/SIDER_PreClinical/MolBERT/BERT_pretraining_init_MolBERT_masking_head/Training_loss/"
model_weights_path = "/projects/home/mmasood1/Model_weights/invitro/invitro_1million/MolBERT/Retrain_on_top_of_BERT/complete_1m_300k_ADME/BERT_pretraining_init_MolBERT_masking_head/"
