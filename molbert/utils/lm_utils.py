...
def convert_example_to_features(example, max_seq_length, tokenizer, original_smiles, inference_mode: bool = False):
    """
    ...
    raw_token_len = len(example.tokens_a)
    raw_token = tokens_a
    ...
    if len(input_ids) > max_seq_length:
        ...
        print("original_smiles", len(original_smiles), original_smiles)
        print("raw_token", raw_token_len, raw_token)
        ...
        #invalid_SMILES = pd.read_csv(data_dir + 'invalid_SMILES')
        #new_row = pd.Series({"invalid_smiles": smile})
        #invalid_SMILES = invalid_SMILES.append(new_row, ignore_index=True)
        #invalid_SMILES.to_csv(data_dir + 'invalid_SMILES', index = False)
