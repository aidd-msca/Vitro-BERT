...
class MolBertFeaturizer:
    ...
    def __init__(
        ...
        #self.hparams_path = os.path.join(self.model_dir, 'hparams_homolumo.yaml')
        ...
        #self.model = FinetuneSmilesMolbertModel(self.config)
    ...
    def load_featurizer(self, config_dict):
        ...
        #featurizer = SmilesIndexFeaturizer.bert_smiles_index_featurizer(max_seq_len)
        #elements = featurizer.load_periodic_table()[0]
        #featurizer = SmilesIndexFeaturizer.bert_smiles_index_featurizer(max_length=max_seq_len, 
